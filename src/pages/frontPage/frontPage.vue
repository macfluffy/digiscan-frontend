...
<template>
    <section class="flex-container flex-columns" id="front-page-main">
        <div id="front-page-logo-container">
            <img 
                :src="logo" 
                alt="Front Page Digiscan Logo" 
                id="front-page-logo" 
            />
        </div>
...
<style scoped src="./frontPage.css" />